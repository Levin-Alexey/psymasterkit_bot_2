...
METHODOLOGY_HELP_TEXT = (
    ...
    "\n"
    "❤️ Методика <b>Master Kit</b> как раз помогает запустить этот процесс.  Шаг за шагом она позволяет менять внутренние реакции и привычные сценарии, из которых формируется наш обычный день.\n"
    "\n"
