...
NEXT_SCREEN_TEXT = (
    ...
    "\n"
    "Самое сложное в этом состоянии - оно кажется обычным. Человек привыкает.\n"
    "\n"
    "Но именно из таких дней постепенно формируются:\n"
    "- хроническая усталость\n"
    "- потеря интереса\n"
    "- тревога о будущем\n"
    "- ощущение, что вы живёте не той жизнью\n"
    "\n"
    "⭐️ И хорошая новость в том, что всё можно увидеть намного яснее и наконец изменить!\n"
    "\n"
