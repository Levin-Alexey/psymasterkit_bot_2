...
HOW_TEXT = (
    ...
    "❌Потому что чаще всего меняется только <b>поведение на уровне сознания</b>, а глубинные установки в подсознании остаются прежними.\n"
    "И тогда через время человек снова возвращается к привычным реакциям, решениям и результатам.\n"
    "Но возникает важный вопрос: <b>Можно ли изменить установки на уровне подсознания - и тем самым изменить свою жизнь?</b>\n"
    "Да, можно.\n"
